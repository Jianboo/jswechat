...
const sdk = new JSSDK('wx59a6cbb2a20d1069','c6547db5e64daa7fe859a6578652439a');
...
sdk.getJsApiTicket(function(err, ticket){
    console.log(arguments);
});

sdk.getSignPackage('http://119.23.238.246/api/wechat',function(err, signPackage){
    debug(arguments);
});
